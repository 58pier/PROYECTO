...
<div class="title_game">
    <h1>Titulo</h1>
    <div class="game_img">
        <img src=""><?php  /*CARRUSSEL DE IMAGENES DEL JUEGO*/ ?>
    </div>
</div>
<div>
...
<div class="descripcion">
    <h2>Más informacion: <a href="">Click aqui...</a></h2>
    <?php
    /*Link del juego */ ?>
</div>
