...
<form action="admin.php?action=<?php echo $results['formAction'] ?>" method="post">
    ...
    <textarea name="resumen" id="resumen" placeholder="Resumen del juego"  maxlength="100000" value="<?php echo htmlspecialchars($results['juego']->resumen) ?>"> </textarea>
    ...
    <textarea name="descripcion" id="descripcion" placeholder="Descripcion del juego"  maxlength="100000" value="<?php echo htmlspecialchars($results['juego']->descripcion) ?>"> </textarea>
