...
<div class="tit"><h1><?php echo $results['pageTitle'] ?></h1></div>
...
<?php if ($results['juego']->id) { ?>
    <div class="del"><p><a href="admin.php?action=deleteJuego&amp;juegoId=<?php echo $results['juego']->id ?>" onclick="return confirm('Eliminar este juego?)">Eliminar este Juego</a></p>
    </div>
    <?php } ?>
<br>
