...
<form action="admin.php?action=<?php echo $results['formAction'] ?>" method="post">
    ...
    <div class="editjuego">
        ...
        <input type="text" name="procesador" id="procesador" placeholder="Procesador" maxlength="255" value="<?php echo htmlspecialchars($results['juego']->getRequerimientos(0)) ?>">

        <label for="so"> SistOperativo</label>
        <input type="text" name="so" id="so" placeholder="Sistema Operativo" maxlength="255" value="<?php echo htmlspecialchars($results['juego']->getRequerimientos(1)) ?>">

        <label for="memoria"> Memoria Ram..</label>
        <input type="text" name="memoria" id="memoria" placeholder="Memoria RAM" maxlength="255" value="<?php echo htmlspecialchars($results['juego']->getRequerimientos(2)) ?>">

        <label for="tarjeta"> Gráficos.....</label>
        <input type="text" name="tarjeta" id="tarjeta" placeholder="Tarjeta de video" maxlength="255" value="<?php echo htmlspecialchars($results['juego']->getRequerimientos(3)) ?>">
        ...
        <label for="derechos_autor"> DerechosAutor</label>
        ...
        <textarea name="resumen" id="resumen" placeholder="Resumen del juego" rows="10" cols="107" required maxlength="100000"><?php echo htmlspecialchars($results['juego']->resumen) ?></textarea>

        <label for="descripcion"> Descripcion del Juego</label>
        <textarea name="descripcion" id="descripcion" placeholder="Descripcion del juego" rows="10" cols="107" required maxlength="100000"><?php echo htmlspecialchars($results['juego']->descripcion) ?></textarea>
    </div>
    <div class="botones">
